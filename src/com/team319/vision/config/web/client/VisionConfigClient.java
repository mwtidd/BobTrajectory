 ...
 *
 */
public class VisionConfigClient {

	private static Logger logger = LoggerFactory.getLogger(VisionConfigClient.class);

	public static void start(String ipAddress) throws Exception {

		URI destUri = new URI("ws://"+ipAddress+":5803/vision/config");
        ...
        new Thread(new Runnable() {
			...
			public void run() {
				...
				while(!connected){
			    	...
			    	try{
			        	client.start();
			            VisionConfigClientSocket socket = new VisionConfigClientSocket();
