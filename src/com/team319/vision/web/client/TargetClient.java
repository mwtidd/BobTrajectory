...
public class TargetClient {
	...
	private static Logger logger = LoggerFactory.getLogger(TargetClient.class);

	public static void start(String ipAddress) throws Exception {

		URI destUri = new URI("ws://"+ipAddress+":5803/vision/target");
        ...
        new Thread(new Runnable() {
			...
			public void run() {
				...
				while(!connected){
			    	...
			    	try{
			        	client.start();
			            TargetClientSocket socket = new TargetClientSocket();
