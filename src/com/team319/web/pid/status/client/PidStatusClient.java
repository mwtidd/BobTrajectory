 ...
 *
 */
public class PidStatusClient {

	private static Logger logger = LoggerFactory.getLogger(PidStatusClient.class);

	public static void start(String ipAddress) throws Exception {

		URI destUri = new URI("ws://"+ipAddress+":5803/pid/status");
        ...
        new Thread(new Runnable() {
			...
			public void run() {
				...
				while(!connected){
			    	...
			    	try{
			        	client.start();
			            PidStatusClientSocket socket = new PidStatusClientSocket();
