 ...
 *
 */
public class TrajectoryProgressClient {

	private static Logger logger = LoggerFactory.getLogger(TrajectoryProgressClient.class);


	public static void start(String ipAddress) throws Exception {

		URI destUri = new URI("ws://"+ipAddress+":5803/trajectory/progress");
        ...
        new Thread(new Runnable() {
			...
			public void run() {
				...
				while(!connected){
			    	...
			    	try{
			        	client.start();
			            TrajectoryProgressClientSocket socket = new TrajectoryProgressClientSocket();
