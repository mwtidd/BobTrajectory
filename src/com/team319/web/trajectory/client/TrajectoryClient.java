 ...
 *
 * It is responsible to establishing a socket connection between the trajectory server and the robot
 *
 * @author mwtidd
 *
 */
public class TrajectoryClient {
	...
	private static Logger logger = LoggerFactory.getLogger(TrajectoryClient.class);

	public static void start(String ipAddress) throws Exception {

        URI destUri = new URI("ws://"+ipAddress+":5803/trajectory");
